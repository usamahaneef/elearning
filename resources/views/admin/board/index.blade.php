        ...
        <div class="col-md-12 col-sm-12  ">
            <div class="x_panel">
                <div class="x_title text-right">
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#boardModal">Add Board</button>
                </div>
                <!-- Modal -->
                                ...
                                @forelse ($boards as $key => $board)
                                    <tr class="even pointer">
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="editModal{{$board->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Add Board</h5>
                                                    ...
                                                    <form action="{{url('admin/board/edit' , $board)}}" method="POST">
                                                    @csrf
                                                    <div class="modal-body">
                                                            <div class="form-group">
                                                                <label for="name">Board Name</label>
                                                                <input type="text" id="name" name="name" class="form-control"
                                                                       value="{{$board->name , old('name')}}"
                                                                       placeholder="Board Name">
                                                                @error('name')
                                                                <span class="text-danger text-sm pull-right">{{$errors->first('name')}}</span>
                                                                @enderror
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-sm btn-primary">Update Board</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                </div>
